if(ABLASTR_FFT)
    ...
    elseif(WarpX_COMPUTE STREQUAL SYCL)
        ferrox_make_third_party_includes_system(AMReX::SYCL FFT)
    else()
        if(WarpX_FFTW_SEARCH STREQUAL CMAKE)
            ferrox_make_third_party_includes_system(FFTW3::fftw3${HFFTWp} FFT)
        else()
            ferrox_make_third_party_includes_system(PkgConfig::fftw3${HFFTWp} FFT)
        endif()
